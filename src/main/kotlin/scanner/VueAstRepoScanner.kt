...
class VueAstRepoScanner(
    private val astEngine: VueAstEngine = createDefaultVueAstEngine(),
    private val fallbackScanner: VueRepoScanner = VueRepoScanner(),
...
fun interface VueAstEngine {
    fun scanRepo(repoId: RepoId, repoRoot: Path): AstScanOutcome
}

object NoopVueAstEngine : VueAstEngine {
