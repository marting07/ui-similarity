...
data class AngularAstScanRequest(
    val repoHost: String,
...
data class AngularAstComponentDescriptor(
...
data class AngularAstScanResponse(
    val status: String,
    val components: List<AngularAstComponentDescriptor>,
    val error: String? = null
)

object AngularAstContractJson {
    fun encodeRequest(request: AngularAstScanRequest): String {
        return buildString {
            append("{")
    ...
    fun decodeResponse(json: String): AngularAstScanResponse? {
        ...
        return AngularAstScanResponse(status = status, components = components, error = error)
    }
